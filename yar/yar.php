 ...
 * @link https://secure.php.net/manual/zh/yar.constants.php
 */
 ...
 * @link https://secure.php.net/manual/zh/class.yar-server.php
 */
class Yar_Server {
     ...
     * @link https://secure.php.net/manual/zh/yar-server.construct.php
     */
     ...
     * @return bool
     * @link https://secure.php.net/manual/zh/yar-server.handle.php
     */
...
class Yar_Client {
     ...
     * @link https://secure.php.net/manual/zh/yar-client.call.php
     */
     ...
     * @link https://secure.php.net/manual/zh/yar-client.construct.php
     */
     ...
     * @link https://secure.php.net/manual/zh/yar-client.setopt.php
     */
...
class Yar_Concurrent_Client {
     ...
     * @return int
     * @link https://secure.php.net/manual/zh/yar-concurrent-client.call.php
     */
     ...
     * @return bool
     * @link https://secure.php.net/manual/zh/yar-concurrent-client.loop.php
     */
     ...
     * Clean all registered calls
     * @return bool
     * @link https://secure.php.net/manual/zh/yar-concurrent-client.reset.php
     */
 ...
 * @Author weizhimiao001@lianjia.com
 * @link https://secure.php.net/manual/zh/class.yar-server-exception.php
 */
class Yar_Server_Exception extends Exception {
     ...
     * @return string
     * @link https://secure.php.net/manual/zh/yar-server-exception.gettype.php
     */
 ...
 * @Author weizhimiao001@lianjia.com
 * @link https://secure.php.net/manual/zh/class.yar-client-exception.php
 */
class Yar_Client_Exception extends Exception {
    /**
     * Retrieve exception's type
     * @return string "Yar_Exception_Client".
     * @link https://secure.php.net/manual/zh/yar-client-exception.gettype.php
     */
    public function getType (){}
}