 ...
 * @link https://www.php.net/manual/zh/function.socket-addrinfo-lookup.php
 * @param string $host <p>
 * Hostname to search.
 * </p>
 ...
 * @link https://www.php.net/manual/zh/function.socket-addrinfo-connect.php
 ...
 * @link https://www.php.net/manual/zh/function.socket-addrinfo-bind.php
 * @param resource $addr <p>
 * Resource created from {@see socket_addrinfo_lookup()}
 * </p>
 * @return resource Socket resource on success or NULL on failure.
 ...
 * @link https://www.php.net/manual/zh/function.socket-addrinfo-explain.php
 * @param resource $addr <p>
 * Resource created from {@see socket_addrinfo_lookup()}
 * </p>
 ...
 * (PHP 5 &gt;=5.5.0)<br/>
 * Send a message
 * @link https://secure.php.net/manual/zh/function.socket-sendmsg.php
 * @param resource $socket
 * @param array $message
 * @param int $flags
 * @return int|false
...
/**
 * Read a message
 * @link https://secure.php.net/manual/zh/function.socket-recvmsg.php
 * @param resource $socket
