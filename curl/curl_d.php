...
//TODO: copy proper descriptions for all constants from https://php.net/manual/zh/function.curl-setopt.php
...
/**
 * @link https://secure.php.net/manual/zh/function.curl-setopt.php
 * @since 5.3.2
 */
