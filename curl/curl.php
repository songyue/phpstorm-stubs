...
class CURLFile {
     ...
     * @link https://secure.php.net/manual/zh/curlfile.construct.php
    ...
    /**
     * Get file name
     * @link https://secure.php.net/manual/zh/curlfile.getfilename.php
    ...
    /**
     * Get MIME type
     * @link https://secure.php.net/manual/zh/curlfile.getmimetype.php
     ...
     * @link https://secure.php.net/manual/zh/curlfile.getpostfilename.php
    ...
    /**
     * Set MIME type
     * @link https://secure.php.net/manual/zh/curlfile.setmimetype.php
     * @param string $mime
     * @since 5.5
     */
     ...
     * https://secure.php.net/manual/zh/curlfile.setpostfilename.php
    ...
    /**
     * @link https://secure.php.net/manual/zh/curlfile.wakeup.php
 ...
 * @link https://secure.php.net/manual/zh/function.curl-share-close.php
 * @param resource $sh <p>
 * A cURL share handle returned by  {@link https://secure.php.net/manual/zh/function.curl-share-init.php curl_share_init()}
 * </p>
 * @return void
 * @since 5.5
 */
 ...
 * @link https://secure.php.net/manual/zh/function.curl-share-init.php
 ...
 * @link https://secure.php.net/manual/zh/function.curl-share-setopt.php
 * @param resource $sh <p>
 * A cURL share handle returned by  {@link https://secure.php.net/manual/zh/function.curl-share-init.php curl_share_init()}.
 * </p>
 ...
 * @link https://secure.php.net/manual/zh/function.curl-strerror.php
 ...
 * @link https://secure.php.net/manual/zh/function.curl-unescape.php
 * @param resource $ch <p>A cURL handle returned by
 * {@link https://secure.php.net/manual/zh/function.curl-init.php curl_init()}.</p>
 * @param string $str <p>
 ...
 * @link https://secure.php.net/manual/zh/function.curl-escape.php
 * @param resource $ch <p>
 ...
 * @param string $postname [optional] <p>Name of the file.</p>
 * @return CURLFile
 * Returns a {@link https://secure.php.net/manual/zh/class.curlfile.php CURLFile} object.
 * @since 5.5
 */
 ...
 * @link https://secure.php.net/manual/zh/function.curl-multi-setopt.php
 * @param resource $mh
 * @param int $option <p>
 ...
 * @link https://secure.php.net/manual/zh/function.curl-multi-strerror.php
 * @param int $errornum <p>
 ...
 * @link https://secure.php.net/manual/zh/function.curl-pause.php
 * @param resource $ch
 * <p>A cURL handle returned by {@link https://secure.php.net/manual/zh/function.curl-init.php curl_init()}.</p>
 ...
 * @link https://secure.php.net/manual/zh/function.curl-reset.php
 * @param resource $ch <p>A cURL handle returned by
 * {@link https://secure.php.net/manual/zh/function.curl-init.php curl_init()}.</p>
 * @return void
 * @since 5.5
