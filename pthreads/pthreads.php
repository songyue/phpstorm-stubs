 ...
 * @link https://secure.php.net/manual/zh/class.pool.php
 */
class Pool {
    /**
     ...
     * @link https://secure.php.net/manual/zh/pool.construct.php
     ...
     * @link https://secure.php.net/manual/zh/pool.collect.php
     ...
     * (PECL pthreads &gt;= 2.0.0)<br/>
     * Resize the Pool
     * @link https://secure.php.net/manual/zh/pool.resize.php
     ...
     * @link https://secure.php.net/manual/zh/pool.shutdown.php
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/zh/pool.submit.php
     ...
     * @link https://secure.php.net/manual/zh/pool.submitTo.php
 ...
 *
 * @link https://secure.php.net/manual/zh/class.threaded.php
 */
class Threaded implements Collectable, Traversable, Countable, ArrayAccess {
     ...
     * @link https://secure.php.net/manual/zh/threaded.chunk.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.count.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.extend.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.getterminationinfo.php
     ...
     * @link https://secure.php.net/manual/zh/thread.isrunning.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.isterminated.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/threaded.iswaiting.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/threaded.lock.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/threaded.merge.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.notify.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * Threaded::notify()).
     * @link https://secure.php.net/manual/zh/threaded.notifyone.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/threaded.pop.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.run.php
     * @return void
     */
    public function run() {}
     ...
     * @link https://secure.php.net/manual/zh/threaded.shift.php
     ...
     * @link https://secure.php.net/manual/zh/threaded.synchronized.php
     ...
     * @see Threaded::synchronized()
     * @link https://secure.php.net/manual/zh/threaded.unlock.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * referenced object
     * @link https://secure.php.net/manual/zh/threaded.wait.php
 ...
 *
 * @link https://secure.php.net/manual/zh/class.thread.php
 */
class Thread extends Threaded implements Countable, Traversable, ArrayAccess {
     ...
     * @link https://secure.php.net/manual/zh/thread.detach.php
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.getcreatorid.php
     ...
     * @link https://secure.php.net/manual/zh/thread.getcurrentthread.php
     ...
     * @link https://secure.php.net/manual/zh/thread.getcurrentthreadid.php
     * @return int <p>A numeric identity</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.getthreadid.php
     * @return int <p>A numeric identity</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.globally.php
     ...
     * @link https://secure.php.net/manual/zh/thread.isjoined.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.isstarted.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.join.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.kill.php
     * @return bool <p>A boolean indication of success</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/thread.start.php
 ...
 * objects run method.
 * @link https://secure.php.net/manual/zh/class.worker.php
 */
class Worker extends Thread implements Traversable, Countable, ArrayAccess {
     ...
     * optionally given collector
     * @link https://secure.php.net/manual/zh/worker.collect.php
     ...
     * @link https://secure.php.net/manual/zh/worker.getstacked.php
     ...
     * @link https://secure.php.net/manual/zh/worker.isshutdown.php
     ...
     * @link https://secure.php.net/manual/zh/worker.isworking.php
     * @return bool <p>A boolean indication of state</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/worker.shutdown.php
     ...
     * @link https://secure.php.net/manual/zh/worker.stack.php
     ...
     * @link https://secure.php.net/manual/zh/worker.unstack.php
     * @return int <p>The new size of the stack</p>
     */
 ...
 * @link https://secure.php.net/manual/zh/class.collectable.php
 */
interface Collectable {
    /**
     * (PECL pthreads &gt;= 2.0.8)<br/>
     * Can be called in {@link Pool::collect()} to determine if this object is garbage
     * @link https://secure.php.net/manual/zh/collectable.isgarbage.php
     ...
     * @link https://secure.php.net/manual/zh/collectable.setgarbage.php
     * @return void
     */
    public function setGarbage();
}
 ...
 * Mutex functionality.
 * @link https://secure.php.net/manual/zh/class.mutex.php
 */
class Mutex {
    /**
     * (PECL pthreads &lt; 3.0.0)<br/>
     * Create, and optionally lock a new Mutex for the caller
     * @link https://secure.php.net/manual/zh/mutex.create.php
     ...
     * @link https://secure.php.net/manual/zh/mutex.destroy.php
     ...
     * blocking.
     * @link https://secure.php.net/manual/zh/mutex.lock.php
     * @param int $mutex <p>A handle returned by a previous call to
     * {@see Mutex::create()}.</p>
     * @return bool <p>A boolean indication of success.</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/mutex.trylock.php
     ...
     * @link https://secure.php.net/manual/zh/mutex.unlock.php
     * @param int $mutex <p>A handle returned by a previous call to
     * {@see Mutex::create()}.</p>
 ...
 * Condition Variables.
 * @link https://secure.php.net/manual/zh/class.cond.php
 */
class Cond {
    /**
     * (PECL pthreads &lt; 3.0.0)<br/>
     * Broadcast to all Threads blocking on a call to Cond::wait().
     * @link https://secure.php.net/manual/zh/cond.broadcast.php
     ...
     * @link https://secure.php.net/manual/zh/cond.create.php
     ...
     * @link https://secure.php.net/manual/zh/cond.destroy.php
     * @param int $condition <p>A handle to a Condition Variable returned by a previous call to
     * {@see Cond::create()}</p>
     * @return bool <p>A boolean indication of success.</p>
     */
     ...
     * @link https://secure.php.net/manual/zh/cond.signal.php
     * @param int $condition <p>A handle to a Condition Variable returned by a previous call to
     * {@see Cond::create()}</p>
     * @return bool <p>A boolean indication of success.</p>
     */
     ...
     * limit waiting time.
     * @link https://secure.php.net/manual/zh/cond.wait.php
 ...
 * @see Threaded
 * @link https://secure.php.net/manual/zh/class.volatile.php
 */
