...
/**
 * Radius constants
 * @link https://secure.php.net/manual/zh/radius.constants.php
 */
...
/**
 * RADIUS Options
 * @link https://secure.php.net/manual/zh/radius.constants.options.php
 */
...
/**
 * RADIUS Packet Types
 * @link https://secure.php.net/manual/zh/radius.constants.packets.php
 */
 ...
 * @link https://secure.php.net/manual/zh/radius.constants.attributes.php
 */
 ...
 * @link https://secure.php.net/manual/zh/function.radius-acct-open.php
 ...
 * @link https://secure.php.net/manual/zh/function.radius-add-server.php
 ...
 * @link https://secure.php.net/manual/zh/function.radius-auth-open.php
 * @return resource|false Returns a handle on success, <b>FALSE</b> on error. This function only fails if insufficient memory is available.
 * @since 1.1.0
 */
 ...
 * @link https://secure.php.net/manual/zh/function.radius-close.php
 * @param resource $radius_handle
 * @return bool Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 1.1.0
 */
 ...
 * @link https://secure.php.net/manual/zh/function.radius-config.php
 ...
 * @link https://secure.php.net/manual/zh/function.radius-create-request.php
 * @param resource $radius_handle
