...
class Directory  {
     ...
     * @link https://secure.php.net/manual/zh/directory.close.php
     */
     ...
     * @param resource $dir_handle [optional]
     * @link https://secure.php.net/manual/zh/directory.rewind.php
     */
     ...
     * @param resource $dir_handle [optional]
     * @return string
     * @link https://secure.php.net/manual/zh/directory.read.php
     */
 ...
 * The {@link https://secure.php.net/manual/zh/language.types.string.php string} being converted.
 * </p>
