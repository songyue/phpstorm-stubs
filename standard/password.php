 ...
 * </p>
 * <p>
 * If omitted, a random salt will be generated by {@link "https://secure.php.net/manual/zh/function.password-hash.php" password_hash()} for
 ...
 * Examples of these values can be found on the {@link "https://secure.php.net/manual/zh/function.crypt.php crypt()"} page.
 * </p>
 * <p>
 ...
 * </li>
 * </ul>
 * @link https://secure.php.net/manual/zh/password.constants.php
 */
 ...
 * @link https://secure.php.net/manual/zh/function.password-get-info.php
 * @param string $hash A hash created by password_hash().
 * @return array Returns an associative array with three elements:
 * <ul>
 * <li>
 * <em>algo</em>, which will match a
 * {@link https://secure.php.net/manual/zh/password.constants.php password algorithm constant}
 * </li>
 * <li>
 ...
 * provided when calling  @link https://secure.php.net/manual/zh/function.password-hash.php" password_hash()
 * </li>
 * </ul>
 * @since 5.5
 */
 ...
 * @link https://secure.php.net/manual/zh/function.password-hash.php
 * @param string $password The user's password.
 * @param int $algo A <a href="https://secure.php.net/manual/zh/password.constants.php" class="link">password algorithm constant</a>  denoting the algorithm to use when hashing the password.
 * @param array $options [optional] <p> An associative array containing options. See the <a href="https://secure.php.net/manual/zh/password.constants.php" class="link">password algorithm constants</a> for documentation on the supported options for each algorithm.
 ...
 * @link https://secure.php.net/manual/zh/function.password-needs-rehash.php
 * @param string $hash A hash created by password_hash().
 * @param int $algo A <a href="https://secure.php.net/manual/zh/password.constants.php" class="link">password algorithm constant</a> denoting the algorithm to use when hashing the password.
 ...
 *
 * Checks if the given hash matches the given options.
 * @link https://secure.php.net/manual/zh/function.password-verify.php
 * @param string $password The user's password.
 * @param string $hash A hash created by password_hash().
