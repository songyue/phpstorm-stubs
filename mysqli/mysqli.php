...
class mysqli  {
     ...
     * @link https://secure.php.net/manual/zh/mysqli.error-list.php
     */
    public $error_list;
     ...
     * @link https://secure.php.net/manual/zh/mysqli.begin-transaction.php
	 ...
	 * Characters encoded are NUL (ASCII 0), \n, \r, \, ', ", and Control-Z.
	 * @return string
	 * @link https://secure.php.net/manual/zh/mysqli.real-escape-string.php
	 */
     ...
     * @link https://secure.php.net/manual/zh/mysqli.savepoint.php
     * @param string $name
     * @return bool Returns TRUE on success or FALSE on failure.
     * @since 5.5
     */
	 ...
	 * @link https://secure.php.net/manual/zh/mysqli.ssl-set.php
	 * @param $key <p>
 ...
 * @link https://secure.php.net/manual/zh/mysqli.affected-rows.php
 ...
 * @link https://secure.php.net/manual/zh/mysqli.autocommit.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * PHP > 5.4.0 </br>
 * @link https://secure.php.net/manual/zh/mysqli-stmt.error-list.php
 ...
 * @link https://secure.php.net/manual/zh/mysqli.error.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @return string
 */
...
/**
 * Returns the next field in the result set
 * @link https://secure.php.net/manual/zh/mysqli-result.fetch-field.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
...
/**
 * Returns an array of objects representing the fields in a result set
 * @link https://secure.php.net/manual/zh/mysqli-result.fetch-fields.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
...
/**
 * Fetch meta-data for a single field
 * @link https://secure.php.net/manual/zh/mysqli-result.fetch-field-direct.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
 ...
 * @since 5.3
 * Available only with mysqlnd.
 * @link https://php.net/manual/zh/mysqli.get-cache-stats.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @since 5.3
 * @link https://php.net/manual/zh/mysqli.get-client-stats.php
...
/**
 * Set a named transaction savepoint
 * @link https://secure.php.net/manual/zh/mysqli.release-savepoint.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @param string $name
 * @return bool Returns TRUE on success or FALSE on failure.
 * @since 5.5
