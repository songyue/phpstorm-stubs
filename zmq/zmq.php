...
/**
 * Class ZMQ
 * @link https://secure.php.net/manual/zh/class.zmq.php
 */
class ZMQ
{
    /**
     ...
     * @link https://secure.php.net/manual/zh/zmq.construct.php
     */
...
/**
 * Class ZMQContext
 * @link https://secure.php.net/manual/zh/class.zmqcontext.php
 */
class ZMQContext
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqcontext.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqcontext.getopt.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqcontext.getsocket.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqcontext.ispersistent.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqcontext.setopt.php
     *
...
/**
 * Class ZMQSocket
 * @link https://secure.php.net/manual/zh/class.zmqsocket.php
 */
class ZMQSocket
{
    /**
     ...
     * The on_new_socket is called only when a new underlying socket structure is created.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.bind.php
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.connect.php
     *
     * @param string $dsn The bind dsn, for example transport://address.
     * @param bool $force Tries to bind even if the socket has already been bound to the given endpoint.
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.disconnect.php
     *
     * @param string $dsn The bind dsn, for example transport://address.
     *
     * @return ZMQSocket
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.getendpoints.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.getpersistentid.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.getsockopt.php
     *
     * @since 0MQ 2.0.7
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.getsockettype.php
     *
     * @return int <p>
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.ispersistent.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.recv.php
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.recvmulti.php
     *
     * @param int $mode Pass mode flags to receive multipart messages or non-blocking operation. See ZMQ::MODE_* constants.
     *
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.send.php
     *
     ...
     * If <b>ZMQ::MODE_NOBLOCK</b> is used and the operation would block bool false shall be returned.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.sendmulti.php
     *
     ...
     * @see ZMQ Constant Types for more information.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.setsockopt.php
     *
     ...
     * where transport is one of the following: inproc, ipc, tcp, pgm or epgm.
     *
     * @link https://secure.php.net/manual/zh/zmqsocket.unbind.php
     *
...
/**
 * Class ZMQPoll
 * @link https://secure.php.net/manual/zh/class.zmqpoll.php
 */
class ZMQPoll
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.add.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.clear.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.count.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.getlasterrors.php
     *
     * @return int[]
     */
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.poll.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqpoll.remove.php
     *
...
/**
 * Class ZMQDevice
 * @link https://secure.php.net/manual/zh/class.zmqdevice.php
 */
class ZMQDevice
{
    /**
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.construct.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.getidletimeout.php
     *
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.gettimertimeout.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.run.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.setidlecallback.php
     *
     ...
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.setidletimeout.php
     *
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.settimercallback.php
     *
     * @param callable $cb_func Callback function to invoke when the device is idle. Returning false or a value that evaluates to false from this function will cause the device to stop.
     * @param int $timeout How often to invoke the idle callback in milliseconds. The idle callback is invoked periodically when there is no activity on the device. The timeout value guarantees that there is at least this amount of milliseconds between invocations of the callback function.
     * @param mixed $user_data Additional data to pass to the callback function.
     ...
     * Added in ZMQ extension version 1.1.0.
     *
     * @link https://secure.php.net/manual/zh/zmqdevice.settimertimeout.php
     *
