 ...
 * @param string $format Format accepted by  <a href="https://secure.php.net/manual/zh/function.date.php">date()</a>.
 ...
 * @param string $modify A date/time string. Valid formats are explained in {@link https://secure.php.net/manual/zh/datetime.formats.php Date and Time Formats}.
