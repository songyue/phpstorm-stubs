...
class MemcachePool  {
     ...
     * @link https://secure.php.net/manual/zh/memcache.setserverparams.php
     ...
     * effect when the extension is loaded dynamically via {@link https://secure.php.net/manual/zh/function.dl.php dl()}.
     * </p>
     * @param bool $status [optional] <p>
     * Controls if the server should be flagged as online. Setting this parameter
