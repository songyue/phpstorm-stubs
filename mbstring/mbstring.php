 ...
 * @link https://secure.php.net/manual/zh/function.mb-ereg-replace-callback.php
 * @param string $pattern <p>
 * The regular expression pattern.
 * </p>
 * <p>
 ...
 * @link https://www.php.net/manual/zh/function.mb-chr.php
 * @param int $cp
 ...
 * @link https://www.php.net/manual/zh/function.mb-ord.php
 * @param string $str
 * @param string $encoding
 ...
 * @link https://www.php.net/manual/zh/function.mb-scrub.php
 * @param string $str
 * @param string $encoding
 * @return string|false
 * @since 7.2
