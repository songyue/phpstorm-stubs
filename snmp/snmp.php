...
class SNMP  {
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.max-oids
     */
    public $max_oids;
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.quick-print
     */
    public $quick_print;
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.enum-print
     */
    public $enum_print;
     ...
     * </dl>
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.oid-output-format
     */
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.oid-increasing-check
     */
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.exceptions-enabled
     */
     ...
     * @link https://secure.php.net/manual/zh/class.snmp.php#snmp.props.info
     */
    public $info;
